...
pub struct OpCode {
    ...
    pub len: u8,
    pub cycles: u8, //CPU Cycles, maybe some clock cycles
    pub mode: AddressingMode,
}

impl OpCode {
    fn new(code: u8, label: &'static str, len: u8, cycles: u8, mode: AddressingMode) -> Self {
        OpCode {
            code,
            label,
            len,
...
lazy_static! {
    pub static ref CPU_OP_CODES: Vec<OpCode> = vec![
        //--------- code  label len cycles address_mode
